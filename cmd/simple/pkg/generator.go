...
func init() {
	Logger = log.New(os.Stdout, "[iterators]: ", log.LstdFlags)
}
...
func (d *GenData) SetPackageName(pkg_name string) {
	d.PackageName = pkg_name
}

var (
	Generator *gg.CodeGenerator[*GenData]
)

func init() {
	tmp, err := gg.NewCodeGeneratorFromTemplate[*GenData]("", templ)
	if err != nil {
...
const templ string = `// Code generated by go-iterator. DO NOT EDIT.
package iterators
